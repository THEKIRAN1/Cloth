  ...
  return (
    <>
      <div className="max-w-screen-2xl container mx-auto md:px-20 px-4 flex flex-col md:flex-row">
        <div className="w-full md:w-1/2  md:mr-2 mt-20 md:mt-28 my-5">
       ...
       <div className="mt-10 "> <button className="btn btn-active btn-primary">Login</button></div>
        ...
        <div className="w-full md:w-1/2 md:ml-2  mt-7 md:mt-28 my-5"><img src={dress} className="w-70 h-70" alt=""></img></div>
      </div>
    </>
  )
}
